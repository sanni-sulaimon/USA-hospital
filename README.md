...
Power BI 
_ _ Report structure: Overview · Demographic · Insights pages _ _    
Hospital Problem
...
Objective
Build a single interactive Power BI dashboard that lets hospital management:
...
Patients by Hospital and Condition (excerpt)
...
Key Insights
•	Revenue concentration by condition is shallow, not steep: billing ranges narrowly from $54M to $68M across all 20 conditions no single condition dominates spend, meaning cost-control efforts need to span the full condition list rather than target one or two outliers.
